...
class ListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate{
    ...
    func slideFromRightAnim() {
        self.SystemTimeLabel.slideInFromRight(1.5) // Use this line to specify a duration or completionDelegate
        if count%2==0 {
            self.SystemTimeLabel.text = "飞机"
        } else {
            self.SystemTimeLabel.text = "菜鸟"
        }
        count+=1;
    }
    ...
    public func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int
    {
        ...
        count+=1;
        print(count)
        print(self.SystemTimeLabel.text)
        }
...
//            //self.SystemTimeLabel.slideInFromRight(1.5) // Use this line to specify a duration or completionDelegate
//            
//            if let aLabel = self.SystemTimeLabel {
//                aLabel.slideInFromRight(0.4)
//                aLabel.text = "\(self.count)"
//                self.count+=1
//            }
//        }, completion: nil)
...
extension UIView {
    ...
    // slideFromRight, slide, slideRightTo, etc. are great alternative names
