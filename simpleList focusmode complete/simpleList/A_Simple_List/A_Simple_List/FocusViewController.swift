...
class FocusViewController: UIViewController {
    ...
    let duration = dueList[ 0].timeLeftInSec!
    var currDuration = dueList[ 0].timeLeftInSec!
    var secStayed = 0
    var minStayed = 0
    var hrStayed = 0
    var secStayedinHr = 0
    ...
    var hrString: String = ""
    var min = dueList[0].timeLeftInMin! - dueList[0].timeLeft!*60
    var sec = dueList[0].timeLeftInSec! - dueList[0].timeLeftInMin!*60
    var hr = dueList[0].timeLeft!
    
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        taskNameLabel.text = dueList[0].dueName!
