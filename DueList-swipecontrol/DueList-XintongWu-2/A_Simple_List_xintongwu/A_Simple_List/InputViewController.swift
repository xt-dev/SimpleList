    ...
    func handleSwipes(_ sender : UISwipeGestureRecognizer){
        if(sender.direction == .up){
            ...
            if (InputTextField.text != "")
            {
                ...
                print("!!!!!!!")
                print(String(year) + " " + String(month) + " " + String(day) + " " + String(hour) + " " + String(min))
                let inputDate = time(year: year, month: month, date: day, hour: hour, minute: min)
                let currentDate = time(year: currentTime.component(.year, from: date as Date), month: currentTime.component(.month, from: date as Date), date: currentTime.component(.day, from: date as Date), hour: currentTime.component(.hour, from: date as Date), minute: currentTime.component(.minute, from: date as Date))
                let cur_dueElement = DueElement(dueName: InputTextField.text!, dueDate: inputDate, createdDate: currentDate)
